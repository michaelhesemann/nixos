{
  ...
  inputs = {
    ...
    nixpkgs-php-5-6-36.url = "github:/nixos/nixpkgs/archive/a5c9c6373aa35597cd5a17bc5c013ed0ca462cf0.tar.gz";
    nixpkgs-mysql-8-0-43.url = "github:/nixos/nixpkgs/archive/5a8650469a9f8a1958ff9373bd27fb8e54c4365d.tar.gz";
  };
